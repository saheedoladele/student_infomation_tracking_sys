      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="row">
                ...
                <div class="col-lg-3">
                <label for="surname"><b>Current GPA</b> </label>
                    <input type="text" name="gpa" id="gpa" placeholder="Enter Current GPA" class="form-control">
                </div>
                <div class="col-lg-3">
                <label for="surname"><b>Semester</b> </label>
            ...
            <div class="row">
                ...
                <label for="surname"><b>Level</b> </label>
                    <input type="text" name="lev" id="lev" placeholder="" readonly class="form-control">
                </div>
            </div>
          </div>         
...
<br>
            <div class="row">
                <div class="col-lg-6"> 
               <button class="btn btn-secondary" id="save_acc"><i class="fa fa-save"></i> Save Record</button>
               <button class="btn btn-success" id="update_acc"><i class="fa fa-edit"></i> Update Record</button>
                </div>
            </div>
